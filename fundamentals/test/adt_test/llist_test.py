...
import sys
import unittest
from adt.llist import sllist
from adt.llist import sllistnode
from adt.llist import dllist
from adt.llist import dllistnode
...
@attr(species="clique", genus="fundamentals", family="adt", name="llist")
