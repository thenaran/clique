...
from rpclib.tornado import ioloop
from rpclib.tornado.log import gen_log, app_log
from rpclib.tornado.netutil import ssl_wrap_socket, ssl_match_hostname, SSLCertificateError
from rpclib import stackcontext
from rpclib.tornado.util import bytes_type

try:
    from rpclib.tornado.platform.posix import _set_nonblocking
except ImportError:
...
class BaseIOStream(object):
    ...
    def read_bytes(self, num_bytes, callback, streaming_callback=None):
        ...
        self._streaming_callback = stackcontext.wrap(streaming_callback)
        self._try_inline_read()
    ...
    def write(self, data, callback=None):
        ...
        self._write_callback = stackcontext.wrap(callback)
    ...
    def set_close_callback(self, callback):
        ...
        self._close_callback = stackcontext.wrap(callback)
    ...
    def _run_callback(self, callback, *args):
        ...
        with stackcontext.NullContext():
            # stackcontext was already captured in callback, we don't need to
    ...
    def _set_read_callback(self, callback):
        ...
        self._read_callback = stackcontext.wrap(callback)
    ...
    def _add_io_state(self, state):
        """Adds `state` (IOLoop.{READ,WRITE} flags, str(self) to our event handler.
    ...
    def connect(self, address, callback=None, server_hostname=None):
        ...
        try:
            ...
            if e.args[0] not in (errno.EINPROGRESS, errno.EWOULDBLOCK):
                ...
                self.close(exc_info=True)
                return
        self._connect_callback = stackcontext.wrap(callback)
        self._add_io_state(self.io_loop.WRITE)
