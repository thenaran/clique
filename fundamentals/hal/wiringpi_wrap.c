...
SWIGINTERN PyObject *_wrap_waitForInterruptSys(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int arg2 ;
  int val1 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:waitForInterruptSys",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "waitForInterruptSys" "', argument " "1"" of type '" "int""'");
  }
  arg1 = (int)(val1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "waitForInterruptSys" "', argument " "2"" of type '" "int""'");
  }
  arg2 = (int)(val2);
  result = waitForInterruptSys(arg1,arg2);
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"waitForInterruptSys", _wrap_waitForInterruptSys, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
